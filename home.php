...
<html lang="pt-br">
    ...
    <body>
        <!-- Navigation-->
                ...
                <div class="container">
                <a class="navbar-brand" href="pesquisar.php">Empresa de cadastro</a>
         ...
         <div class="row">
             <div class="col">
               <h1>Login cadastro</h1>
                <form action = "cadastrologin.php" method= "POST" enctype= "multipart/form-data">
                <div class="form-control-lg">
                      ...
                      <div class="form-control-lg">    
                        ...
                        <input type="text" class="form-control"   placeholder="Digite seu login ..." name="login"  required/>
                      </div>
                      <div class="form-control-lg">
